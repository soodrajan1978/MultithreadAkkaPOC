...
public class ZipFiles {
	...
	public static void main(String[] args) {
		...
		// String fileName =System.getProperty("user.home")+"/NBC_CSV/employee_1.csv";
		String filedir = System.getProperty("user.home") + "/NBC_CSV";
		File dir = new File(filedir);
		String zipDirName = System.getProperty("user.home") + "/NBC_CSV/employee1.zip";
